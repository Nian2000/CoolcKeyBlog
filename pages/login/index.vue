<template>
	<view class="login">
		...
		<view class="content padding-xl">
			<!-- 头部logo -->
			<view class="flex justify-center"><image :src="logoImage" mode="widthFix" class="header"></image></view>
			<view class="flex justify-center"><view class="">小胡宅基地，欢迎你！</view></view>
			<!-- 主体表单 -->
			<view class="main">
...
export default {
	data: function() {
		return {
			// logo图片
			logoImage: 'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-hzqasl/7ff730f0-f4d1-11ea-b680-7980c8a877b8.png',
			pageLoad: false,
			pageData: {},
			notephone: '请输入手机号码',
			notepwd: '请输入密码',
